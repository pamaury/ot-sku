...
def create_presign_release(pargs):
    # Note this tag does not use the final release tag but instead has a _BUILD suffix
    # to make it clear that this is not the final release.
    ...
    # <tag> ...
    if any(release.split()[0] == release_tag for release in release_list):
